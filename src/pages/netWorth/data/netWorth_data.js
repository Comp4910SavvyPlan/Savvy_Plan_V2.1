export const netWorthWizard_data = [
  //This array is mapped through to render data in the add form
  {
...
export const individualItem_data = (
  ...
  interestRate: {
    //these are the details passed to the range bar as range bar props
    rangeBarValue: 0,
    name: "interestRate",
    max: 0.25,
    min: 0,
  ...
  bookValue: {
    //The purchse price of the asset or starting debt value of a debt
    rangeBarValue: 0,
    financialValue: 0,
    name: "bookValue",
