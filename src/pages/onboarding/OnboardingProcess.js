    ...
    <Wrapper>
      ...
      <Buttons>
        <ButtonLight
          backward
          onClick={() =>
            setCountAndProgress("onboarding", count > 0 ? count - 1 : 0)
          }
        />
        <ButtonLight
          forward
          onClick={() =>
            setCountAndProgress("onboarding", count < 14 ? count + 1 : 14)
          }
        />
      </Buttons>
    </Wrapper>
...
export default connect(mapStateToProps, { setProgress_action })(
  OnboardingProcess
);
//-----------------------------------------------style-----------------------------------------------//
